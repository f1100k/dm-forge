...
// recorder to assert what would have been sent; production never wires the
// noop — it is the dev/test fallback (Tech Design §3.3, §7).
...
// so email-triggering flows stay green offline (F4 acceptance criterion). The
